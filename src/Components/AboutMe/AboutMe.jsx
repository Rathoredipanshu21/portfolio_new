  ...
  return (
    <div className="aboutMe-container">
      ...
      <div className="aboutMe-content">
        ...
        <div className="aboutMe-strengths">
          <h3>My key strengths include:</h3>
          <ul>
            <li><FaBrain className="icon bullet" /> Problem-Solving: Adept at identifying challenges and developing effective solutions.</li>
            <li><FaUsers className="icon bullet" /> Collaboration: Experience working in team environments to deliver high-quality results.</li>
            <li><FaCode className="icon bullet" /> Adaptability: Quick to learn new technologies and frameworks to meet project needs.</li>
            <li><FaClipboardList className="icon bullet" /> Attention to Detail: Committed to writing clean, efficient code that adheres to best practices.</li>
            <li><FaCode className="icon bullet" /> User-Centric Design: Focused on creating intuitive and engaging user experiences.</li>
          </ul>
        </div>
